...
?>
    ...
    <form name="authentication_settings" method="post" action="">
        ...
        <?php 
            ...
            ?>
        <tr>
        <td>Entity ID:</td> <td><input name="custom_auth_sp_entity_id" type="text" maxlength="50" size="30" value="<?php echo isset($custom_auth_sp_entity_id) ? $escaper->escapeHtml($custom_auth_sp_entity_id) : "" ?>" /></td>
        </tr>
        <tr>
        <td>Assertion Consumer Service URL:</td> <td><input name="custom_auth_sp_assertion_consumer_service_url" type="text" maxlength="50" size="30" value="<?php echo isset($custom_auth_sp_url) ? $escaper->escapeHtml($custom_auth_sp_url) : "" ?>" /></td>
        </tr>
        <tr>
        <td>Single Logout Service URL:</td> <td><input name="custom_auth_sp_single_logout_service_url" type="text" maxlength="50" size="30" value="<?php echo isset($custom_auth_sp_url) ? $escaper->escapeHtml($custom_auth_sp_url) : "" ?>" /></td>
        </tr>
        <tr>
        <td>Single Logout Service URL:</td> <td><input name="custom_auth_sp_single_logout_service_url" type="text" maxlength="50" size="30" value="<?php echo isset($custom_auth_sp_url) ? $escaper->escapeHtml($custom_auth_sp_url) : "" ?>" /></td>
        </tr>
