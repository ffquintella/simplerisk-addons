...
?>
    ...
    <form name="authentication_settings" method="post" action="">
        ...
        <tr>
        <td>Assertion Consumer Service URL:</td> <td><input name="custom_auth_sp_assertion_consumer_service_url" type="text" maxlength="100" size="30" value="<?php echo isset($custom_auth_sp_assertion_consumer_service_url) ? $escaper->escapeHtml($custom_auth_sp_assertion_consumer_service_url) : "" ?>" /></td>
        </tr>
        <tr>
        <td>Single Logout Service URL:</td> <td><input name="custom_auth_sp_single_logout_service_url" type="text" maxlength="100" size="30" value="<?php echo isset($custom_auth_sp_single_logout_service_url) ? $escaper->escapeHtml($custom_auth_sp_single_logout_service_url) : "" ?>" /></td>
        </tr>
        <tr class="sub_title"><td colspan=2>
                Identity Provider:
        </td></tr>
